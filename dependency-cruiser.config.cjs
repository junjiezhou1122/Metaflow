...
module.exports = {
  forbidden: [
    ...
    },
    {
      ...
      to: { path: "(^|/)packages/(?!(view|transformation|execution|capture|search|operations)/)" },
    },
    {
    ...
    },
    {
      ...
      to: { path: "(^|/)packages/(?!(view|transformation|execution|automation|capture|search|operations|screenpipe-contracts|adapters)/)" },
    },
    ...adapterIndependenceRules,
    {
      name: "v1-packages-do-not-import-composition-roots",
      severity: "error",
      from: { path: "(^|/)(?:packages/(view|view-package|transformation|execution|automation|capture|search|operations|screenpipe-contracts|adapters)|view-packages)/" },
