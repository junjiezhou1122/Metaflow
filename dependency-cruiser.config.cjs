...
module.exports = {
  forbidden: [
    ...
    },
    {
      ...
      to: { path: "(^|/)packages/(?!(view|transformation|execution|automation|capture|search|authoring|operations|adapters)/)" },
    },
    ...adapterIndependenceRules,
    {
      name: "v1-packages-do-not-import-composition-roots",
      severity: "error",
      from: { path: "(^|/)(?:packages/(view|view-package|transformation|execution|automation|capture|search|authoring|operations|adapters)|view-packages)/" },
